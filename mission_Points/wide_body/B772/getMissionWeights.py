...
def plot_2d_histogram(df, mach_min, mach_max, cl_min, cl_max, mach_points_5, cl_points_5, surrounding_bins_list, weights_5,plot_box, plot_points):
    ...
    if plot_points:
        plt.savefig("Plots/B772_Mach_CL_hist_weights.png")
    if plot_box:
        plt.savefig("Plots/B772_Mach_CL_hist_box.png")
    else:
        plt.savefig("Plots/B772_Mach_CL_hist.png")
...
# Load the dataset
file_path = "data/B77x_histogram_data.csv"
df = pd.read_csv(file_path)
