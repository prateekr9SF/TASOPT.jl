...
#plt.hist(df1['mach'], bins=100, color='C0', edgecolor='black', label='Climb')
#plt.hist(df2['mach'], bins=100, color='C1', edgecolor='black', label='Cruise')
plt.hist(df3['mach'], bins=100, color='C2', edgecolor='black', label='Descent')
